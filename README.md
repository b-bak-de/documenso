<img src="apps/remix/public/bbak-logo.png" alt="B-BAK Logo">

<p align="center" style="margin-top: 20px">
  <p align="center">
  Digital document signing by B-BAK.
  <br>
    <a href="https://b-bak.de"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://b-bak.de">Website</a>
    ·
    <a href="https://b-bak.de">Documentation</a>
    ·
    <a href="https://github.com/b-bak-de/documenso/issues">Issues</a>
  </p>
</p>

<p align="center">
   <a href="https://b-bak.de"><img src="https://img.shields.io/badge/B--BAK-b--bak.de-%235865F2" alt="Visit B-BAK"></a>
   <a href="https://github.com/b-bak-de/documenso/stargazers"><img src="https://img.shields.io/github/stars/b-bak-de/documenso" alt="Github Stars"></a>
   <a href="https://github.com/b-bak-de/documenso/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-AGPLv3-purple" alt="License"></a>
   <a href="https://github.com/b-bak-de/documenso/pulse"><img src="https://img.shields.io/github/commit-activity/m/b-bak-de/documenso" alt="Commits-per-month"></a>
   <a href="https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/b-bak-de/documenso">
...
Signing documents digitally should be fast and easy. B-BAK provides a customer-facing signing experience built on the open-source Documenso project, with the source available for review and self-hosting.
...
- Try B-BAK by visiting [b-bak.de](https://b-bak.de).
...
- B-BAK stays open source. You can read, audit, run, and fork the code.
