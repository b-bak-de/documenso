...
export const DEFAULT_BRAND_COLORS = {
  background: '#f8f9fa', //              B-BAK surface
  foreground: '#1b263b', //              B-BAK deep
  ...
  fieldCard: '#f1f4f7', //               B-BAK muted surface
  fieldCardBorder: '#859bae', //         B-BAK highlight
  fieldCardForeground: '#1b263b', //     B-BAK deep
  widget: '#f7f7f7', //                  0 0% 97%
  widgetForeground: '#f2f2f2', //        0 0% 95%
  border: '#e2e8f0', //                  214.3 31.8% 91.4%
  input: '#e2e8f0', //                   214.3 31.8% 91.4%
  primary: '#1b263b', //                 B-BAK deep
  primaryForeground: '#ffffff', //       B-BAK inverse
