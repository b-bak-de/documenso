...
export const templates: Record<string, TemplateDefinition> = {
  ...
  'document-invite': {
    ...
    fields: {
      ...
      inviterEmail: { type: 'text', label: 'Inviter email', default: 'sender@example.com' },
  ...
  'document-rejected': {
    ...
    fields: {
      recipientName: recipientNameField,
      documentName: documentNameField,
      documentUrl: { type: 'text', label: 'Document URL', default: 'https://b-bak.de' },
      rejectionReason: {
        type: 'textarea',
  ...
  'organisation-invite': {
    ...
    fields: {
      ...
      organisationName: { type: 'text', label: 'Organisation name', default: 'B-BAK' },
    },
  },
  'organisation-join': {
  ...
  'confirm-team-email': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'B-BAK' },
    },
  },
  'team-delete': {
    name: 'Team delete',
  ...
  'team-email-removed': {
    ...
    fields: {
      teamName: { type: 'text', label: 'Team name', default: 'B-BAK' },
      teamEmail: { type: 'text', label: 'Team email', default: 'team@example.com' },
    },
  },
  ...
  'confirm-email': {
    ...
    fields: {
      confirmationLink: {
        ...
        default: 'https://b-bak.de/confirm',
      },
    },
  },
  'forgot-password': {
  ...
  'reset-password': {
    ...
    fields: {
      userName: { type: 'text', label: 'User name', default: 'Lucas Smith' },
      userEmail: { type: 'text', label: 'User email', default: 'user@example.com' },
    },
  },
  'access-auth-2fa': {
