  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using B-BAK to perform your electronic document signing. The purpose of this disclosure is to
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by B-BAK, you affirm that you have read and
