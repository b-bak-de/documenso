---
title: Self-Hosting
description: Deploy and manage your own B-BAK instance for complete control over your data, compliance, and customization.
---
...
<Callout type="error">
  **You must generate a signing certificate.** B-BAK does not ship with one. Without a
...
<Callout type="warn">
  **You are responsible for your own network security.** B-BAK applies best-effort, non-exhaustive
...
Get B-BAK running locally in under 5 minutes:

```bash
git clone https://github.com/b-bak-de/documenso.git
cd documenso
cp .env.example .env
...
Self-hosted B-BAK includes full core functionality under the AGPL-3.0 license. If you need enterprise features such as SSO, embed editor white label, or 21 CFR Part 11 compliance, you can activate them with a license key.
...
<Cards>
  <Card
    title="User Guide"
    description="Learn how to use B-BAK for document signing."
    href="/docs/users"
  />
  <Card
    title="Developer Guide"
    description="Integrate B-BAK into your applications using the API."
