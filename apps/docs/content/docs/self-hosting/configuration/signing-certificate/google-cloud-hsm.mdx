...
Create a service account with the `cloudkms.signerVerifier` role so B-BAK can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; B-BAK needs it to embed in signatures.
