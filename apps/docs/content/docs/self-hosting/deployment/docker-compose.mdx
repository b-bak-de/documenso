...
description: Deploy B-BAK with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The B-BAK container waits for the database health check to pass before starting.
...
# Public URL where B-BAK is accessible
...
For production, place B-BAK behind a reverse proxy for SSL termination:
