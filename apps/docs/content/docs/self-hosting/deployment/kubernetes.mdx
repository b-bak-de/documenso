---
title: Kubernetes
description: Deploy B-BAK on Kubernetes for production environments requiring high availability, auto-scaling, and enterprise-grade infrastructure.
---
...
A typical B-BAK Kubernetes deployment consists of:
...
Create a dedicated namespace for B-BAK:
...
Update your B-BAK secret to use the in-cluster database:
...
B-BAK stores documents in the database by default. For high-volume deployments, configure S3-compatible storage.
...
Scale B-BAK based on CPU and memory utilization:
