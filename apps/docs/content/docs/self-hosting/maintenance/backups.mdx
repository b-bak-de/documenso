---
title: Backups
description: Backup strategies for B-BAK data.
---
...
B-BAK stores data in three locations:
...
Create a script to back up all B-BAK components:
...
echo "Starting B-BAK backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily B-BAK Backup
