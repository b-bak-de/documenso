...
description: Diagnose and resolve common issues with your self-hosted B-BAK instance, organized by component.
---
...
B-BAK exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change B-BAK's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart B-BAK
  </Step>
</Steps>
...
- **Community support**: Contact info@b-bak.de
...
For security vulnerabilities, do not open a public issue. Contact info@b-bak.de directly.
