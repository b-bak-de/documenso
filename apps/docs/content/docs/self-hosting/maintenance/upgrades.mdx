---
title: Upgrades
description: Upgrade your self-hosted B-BAK installation to get the latest features, security patches, and bug fixes.
---
...
B-BAK follows [Semantic Versioning](https://semver.org/):
...
<Callout type="info">
  Review the [release notes](https://github.com/b-bak-de/documenso/releases) before upgrading to
...
Check your running B-BAK version:
...
Or visit the [releases page](https://github.com/b-bak-de/documenso/releases).
...
B-BAK runs database migrations automatically when the container starts. No manual intervention is required.
...
Read the [release notes](https://github.com/b-bak-de/documenso/releases) carefully.
