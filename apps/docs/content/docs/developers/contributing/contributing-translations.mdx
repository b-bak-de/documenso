...
description: Learn how to contribute translations to B-BAK and become part of our community.
---
...
We store our translations in PO files, which are located in the B-BAK GitHub repository [here](https://github.com/b-bak-de/documenso/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out B-BAK.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie B-BAK.</0>"
```
...
<Callout type="info">
  If you have any questions, contact info@b-bak.de directly!
</Callout>

Thank you for helping make B-BAK more accessible to users around the world!
