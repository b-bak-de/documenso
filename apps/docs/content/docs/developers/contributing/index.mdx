---
title: Contributing to B-BAK
description: Learn how to contribute to B-BAK and become part of our community.
---
...
If you plan to contribute to B-BAK, please take a moment to feel awesome. People like you are what open source is about. Any contributions, no matter how big or small, are highly appreciated.

This guide will help you get started with contributing to B-BAK.
...
Search the existing [issues](https://github.com/b-bak-de/documenso/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/b-bak-de/documenso/pulls) to see if someone else is already working on the same thing.
...
<Callout type="info">
  If you need help getting started, contact info@b-bak.de.
</Callout>
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate B-BAK
