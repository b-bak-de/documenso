...
description: Why B-BAK unified documents and templates into envelopes, and how to migrate from the deprecated document and template create endpoints.
---
...
<Accordions>
  ...
  <Accordion title="I need more time or help migrating">
    Reach out to [info@b-bak.de](mailto:info@b-bak.de) with your use case and we will
...
- [info@b-bak.de](mailto:info@b-bak.de): migration questions and extensions.
...
- [API Versioning](/docs/developers/api/versioning): how B-BAK versions the public API
