---
title: Manual Setup
description: Manually set up B-BAK on your machine for local development.
---
...
Follow these steps to set up B-BAK on your local machine:

{/* prettier-ignore */}
<Steps>

<Step>
### Fork the B-BAK repository

Fork the [B-BAK repository](https://github.com/b-bak-de/documenso) to your GitHub account.
...
Access the B-BAK application by visiting `http://localhost:3000` in your web browser.
