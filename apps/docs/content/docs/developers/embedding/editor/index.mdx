...
In addition to embedding signing, B-BAK supports embedded editor. It allows your users to create and edit documents, templates, and envelopes without leaving your application.

<Callout type="warn">
  Embedded editor is included with Enterprise plans. It is also available as a paid add-on for the
  Platform Plan. Contact info@b-bak.de for availability.
...
This endpoint requires your B-BAK API key. The token has a default expiration of 1 hour.
