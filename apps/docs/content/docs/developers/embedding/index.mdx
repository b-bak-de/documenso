...
B-BAK offers two types of embedding:
...
<Steps>
<Step>
Navigate to your team's templates in B-BAK
...
For example, `https://b-bak.de/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | B-BAK instance URL. Defaults to the deployed application host. |
