...
- A B-BAK account (cloud or self-hosted)
- A B-BAK account on any plan (Free, Individual, Team, or Enterprise)

<Callout type="info">
  Free accounts include API access with a limit of 5 documents per month. [Upgrade to a paid
  plan details at [b-bak.de](https://b-bak.de) for higher limits.
</Callout>
...
B-BAK-compatible official SDKs handle authentication for you:
