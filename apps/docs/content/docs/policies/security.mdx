---
title: Security
description: Security practices for B-BAK and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/b-bak-de/documenso](https://github.com/b-bak-de/documenso)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from B-BAK is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    B-BAK encrypts sensitive data at the application level:
...
B-BAK operates a responsible disclosure process for security vulnerabilities.
...
- [GitHub releases](https://github.com/b-bak-de/documenso/releases)
- [GitHub security advisories](https://github.com/b-bak-de/documenso/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/b-bak-de/documenso) for releases
...
When self-hosting B-BAK, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: info@b-bak.de
- **General questions**: info@b-bak.de
- **GitHub**: [github.com/b-bak-de/documenso](https://github.com/b-bak-de/documenso)
