...
<Cards>
  ...
  <Card
    ...
    description="Terms governing your use of B-BAK."
...
The complete legal documents are available on the B-BAK website:

- [Privacy Policy](https://b-bak.de/datenschutz)
- [Terms of Service](https://b-bak.de)
