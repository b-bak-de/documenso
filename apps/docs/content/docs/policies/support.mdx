...
Join the B-BAK support channels to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other B-BAK users
...
- **[GitHub Discussions](https://github.com/b-bak-de/documenso/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/b-bak-de/documenso/issues)**: Report confirmed bugs with reproducible steps
...
Paid plans include access to direct support from the B-BAK team.
...
- Email support at info@b-bak.de
- Account and billing assistance
- Technical guidance for B-BAK usage
...
- Private channel for direct communication with the B-BAK team
...
Contact info@b-bak.de for Enterprise support options.
...
- [GitHub Discussions](https://github.com/b-bak-de/documenso/discussions) - Community Q&A

<Callout type="info">
  Enterprise licenses for self-hosted deployments can include dedicated support. Contact
  info@b-bak.de for details.
</Callout>
...
- Guidance on B-BAK features and functionality
...
<Callout type="info">
  ...
  available separately. Contact info@b-bak.de for details.
</Callout>
...
For billing disputes or account issues, email info@b-bak.de with your account details.
...
B-BAK follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | info@b-bak.de                                                  |
| Security issues  | info@b-bak.de                                                  |
| Enterprise sales | info@b-bak.de                                                  |
| Privacy requests | info@b-bak.de                                                  |
| Community        | info@b-bak.de                                                  |
| Bug reports      | [GitHub Issues](https://github.com/b-bak-de/documenso/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How B-BAK handles your data
