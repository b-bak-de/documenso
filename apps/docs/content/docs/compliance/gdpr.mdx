---
title: GDPR
description: Understand how B-BAK handles GDPR compliance for data processing and storage.
---
...
When using B-BAK for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using B-BAK) determine the purposes and means of processing |
| **Data Processor**  | B-BAK processes personal data on your behalf according to your instructions       |
...
B-BAK processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use B-BAK:

<Tabs items={['B-BAK', 'Self-Hosted']}>
<Tab value="B-BAK">
...
Contact info@b-bak.de for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host B-BAK:

- You control all data storage locations
- No data is transmitted to B-BAK's infrastructure
...
- Export user and document data from your B-BAK account
- Delete user accounts and associated documents
- Contact B-BAK support for assistance with cloud-hosted data

## Data Deletion

B-BAK supports data deletion to help fulfill erasure requests:
...
Self-hosting B-BAK can simplify GDPR compliance:
...
- Contact [info@b-bak.de](mailto:info@b-bak.de) to request a DPA
- The DPA covers B-BAK's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with B-BAK is required since no personal data is processed by B-BAK.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use B-BAK, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy B-BAK on your own infrastructure
