...
<Callout type="info">
  B-BAK seals all signed documents cryptographically, regardless of signature level, to prevent
...
B-BAK supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
