...
- **Create one automatically**: B-BAK creates a new "Direct Link Recipient" for you
...
If the recipient has a B-BAK account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public B-BAK profile:
...
![B-BAK profile with direct links](/direct-links/documenso-profile.webp)
...
```html
<a href="https://b-bak.de/d/your-token">Sign our agreement</a>
```
