...
Organisation ownership cannot be transferred through the regular organisation settings. Only a B-BAK instance administrator can transfer ownership through the admin panel.

If you are using B-BAK, contact info@b-bak.de to request an ownership transfer. If you are self-hosting, an instance administrator can follow the steps below.
...
<Steps>
  ...
  <Step>
    Sign in or create a B-BAK account.
  </Step>
  <Step>
